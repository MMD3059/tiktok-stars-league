...
const rules = [
  ...
  { icon: "help-circle", title: "عدد الأسئلة", desc: "20 سؤالاً لكل مباراة — استراحة بعد السؤال 10" },
  { icon: "timer", title: "وقت الإجابة", desc: "10 ثوانٍ لأسئلة المزاد" },
  { icon: "repeat", title: "الدوران", desc: "دورتان ذهاباً وإياباً — 18 مباراة لكل فريق" },
